import avatarJimmy from "@/assets/images/avatarJimmy.png";
import avatarJoshua from "@/assets/images/avatarJoshua.png";
import avatarJayden from "@/assets/images/avatarJayden.png";
import avatarTushar from "@/assets/images/avatarTushar.png";
import avatarShubham from "@/assets/images/avatarShubham.png";

const testimonials = [
  {
    name: "Joshua Pinto",
    position: "Full Stack Developer @ ActiveLoc",
    text: "I had the opportunity to collaborate with Joshi on several projects, and I was always impressed by his ability to break down complex problems into practical solutions. His full-stack knowledge made him a reliable teammate, especially when we faced tight deadlines. Beyond his technical skills, he is approachable and always willing to support others, which made working with him a great experience.",
    avatar: avatarJoshua,
  },
  {
    name: "Tushar Mishra",
  ...
  {
    name: "Shubham",
    position: "Software Developer @ GoApptiv Pvt Ltd",
    text: "Joshi and I worked together on multiple initiatives where his problem-solving skills really stood out. He has a knack for quickly understanding project requirements and translating them into effective technical solutions. His calm and structured approach made collaboration smooth, and I valued the clarity he brought to our discussions. I would gladly work with him again on future projects.",
    avatar: avatarShubham,
  },
]
